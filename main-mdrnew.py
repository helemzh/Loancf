...
class Scenario:
    ...
    aggMDR: float  =0.05 # mdr value of percentage of B0
...
class Output:
    ...
    def getCashflow(self):
        ...
        default_aggMDRV = balancesV * self.scenario.aggMDR * self.scenario.aggMDR_timingV
        scaled_default_aggMDRV = default_aggMDRV[:-1]/ actualBalanceV
        cum_scaled_default_aggMDRV = np.cumsum(scaled_default_aggMDRV)
        actualBalanceV = actualBalanceV * (1 - cum_scaled_default_aggMDRV)
...
if __name__ == '__main__':
    ...
    aggMDR_timing_Vec=np.insert(aggMDR_timing_Vec,0,1)
